...
const DEAL_FIELDS = [
  ...
  'Final_Client.Kleecks_Active',
  'Account_Name.id',
  'Account_Name.Account_Name',
  'Account_Name.Website',
  'Account_Name.Kleecks_Active',
  'Licence',
  'Delivery',
  'Amount',
  'Licence_Lost',
  ...
  for (const raw of deals) {
    ...
    if (!entry) {
      entry = {
        ...
        // "Client Active?" on the account. Kept only as a cross-check against
        // the licence dates — the dashboard does not decide anything with it.
        crmActiveFlag: useFinalClient
          ? raw['Final_Client.Kleecks_Active']
          : raw['Account_Name.Kleecks_Active'],
        deals: [],
        last: null
      };
