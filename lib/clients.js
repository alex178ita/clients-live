...
async function fetchWonClients() {
  ...
  for (const raw of deals) {
    ...
    const deal = {
      ...
      // A licence that ran to its natural end. Distinct from Licence_Lost,
      // which is left false on a deal that simply expired — so without this the
      // dashboard shows a churned client as a perfectly healthy one.
